...
const slidesDir = path.join(__dirname, 'src', 'components', 'ppt', 'slides');
...
export default Slide02;`,
  ...
  3: `// Slide 03: Hero
const Slide03 = () => (
  <div className="w-full h-full flex items-center justify-between max-w-7xl mx-auto gap-12">
  ...
  <div className="w-full h-full flex flex-col justify-center max-w-6xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="bg-[#111] p-12 rounded-3xl border border-white/10 hover:border-white/30 transition-colors">
        <h3 className="text-5xl font-bold mb-6 font-['Horizon','Outfit',sans-serif]">100% OFFLINE</h3>
      ...
      <div className="bg-[#111] p-12 rounded-3xl border border-white/10 hover:border-white/30 transition-colors">
        <h3 className="text-5xl font-bold mb-6 font-['Horizon','Outfit',sans-serif]">0 MS LATENCY</h3>
      ...
      <div className="bg-[#111] p-12 rounded-3xl border border-white/10 hover:border-white/30 transition-colors md:col-span-2">
        <h3 className="text-5xl font-bold mb-6 font-['Horizon','Outfit',sans-serif]">PRIVACY BY DESIGN</h3>
  ...
  <div className="w-full h-full flex flex-col justify-center max-w-6xl mx-auto">
    ...
    <div className="flex gap-16 items-center">
      ...
      <div className="flex-1 space-y-12">
        <h3 className="text-4xl font-bold mb-8">LEDGER</h3>
...
const Slide09 = () => (
  <div className="w-full h-full flex flex-col justify-center max-w-6xl mx-auto">
    ...
    <div className="grid grid-cols-2 gap-x-16 gap-y-12">
      <div>
        <h3 className="text-4xl font-bold mb-4 font-['Horizon','Outfit',sans-serif]">SPEED</h3>
      ...
      <div>
        <h3 className="text-4xl font-bold mb-4 font-['Horizon','Outfit',sans-serif]">INTELLIGENCE</h3>
      ...
      <div>
        <h3 className="text-4xl font-bold mb-4 font-['Horizon','Outfit',sans-serif]">DESIGN</h3>
        <p className="text-xl text-white/60">A premium dark-mode aesthetic that feels like a native operating system tool.</p>
      </div>
      <div>
        <h3 className="text-4xl font-bold mb-4 font-['Horizon','Outfit',sans-serif]">OWNERSHIP</h3>
...
const Slide11 = () => (
  <div className="w-full h-full flex flex-col justify-center max-w-5xl mx-auto text-center">
    ...
    <div className="flex flex-wrap justify-center gap-12 mt-12">
      <div className="text-5xl font-black tracking-tight border border-white/10 px-8 py-4 rounded-full">REACT 19</div>
      <div className="text-5xl font-black tracking-tight border border-white/10 px-8 py-4 rounded-full">VITE PWA</div>
      <div className="text-5xl font-black tracking-tight border border-white/10 px-8 py-4 rounded-full">TAILWIND V4</div>
      <div className="text-5xl font-black tracking-tight border border-white/10 px-8 py-4 rounded-full">FRAMER MOTION</div>
      <div className="text-5xl font-black tracking-tight border border-white/10 px-8 py-4 rounded-full">LOCAL STORAGE</div>
    </div>
  </div>
);
...
const Slide12 = () => (
  <div className="w-full h-full flex flex-col justify-center max-w-6xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="p-10 border border-white/20 hover:border-white transition-colors">
...
const Slide13 = () => (
  <div className="w-full h-full flex items-center justify-between max-w-6xl mx-auto gap-16">
    <div className="flex-1">
      <h2 className="text-6xl font-black uppercase tracking-tight mb-6 font-['Horizon','Outfit',sans-serif]">THE<br/>DASHBOARD</h2>
...
const Slide14 = () => (
  <div className="w-full h-full flex flex-row-reverse items-center justify-between max-w-6xl mx-auto gap-16">
    <div className="flex-1">
      <h2 className="text-6xl font-black uppercase tracking-tight mb-6 font-['Horizon','Outfit',sans-serif]">VISUAL<br/>INSIGHTS</h2>
...
const Slide15 = () => (
  <div className="w-full h-full flex items-center justify-between max-w-6xl mx-auto gap-16">
    <div className="flex-1">
      <h2 className="text-6xl font-black uppercase tracking-tight mb-6 font-['Horizon','Outfit',sans-serif]">DYNAMIC<br/>WARNINGS</h2>
...
const Slide16 = () => (
  <div className="w-full h-full flex flex-col justify-center items-center text-center max-w-4xl mx-auto">
    <h2 className="text-7xl font-black uppercase tracking-tight mb-12 font-['Horizon','Outfit',sans-serif]">OFFLINE. ALWAYS.</h2>
...
const Slide17 = () => (
  <div className="w-full h-full flex items-center justify-between max-w-6xl mx-auto gap-16">
    <div className="flex-1">
      <h2 className="text-6xl font-black uppercase tracking-tight mb-6 font-['Horizon','Outfit',sans-serif]">DATA<br/>OWNERSHIP</h2>
...
const Slide18 = () => (
  <div className="w-full h-full flex flex-col justify-center items-center max-w-5xl mx-auto text-center">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 w-full border border-white">
      <div className="p-16 border-b md:border-b-0 md:border-r border-white flex flex-col justify-center items-center">
...
const Slide19 = () => (
  <div className="w-full h-full flex flex-col justify-center max-w-5xl mx-auto">
    ...
    <div className="space-y-8 pl-8 border-l-2 border-white/20">
      ...
      <div className="relative">
        <div className="absolute w-4 h-4 bg-white/20 rounded-full -left-[41px] top-2"></div>
        <h3 className="text-3xl font-bold">Recurring Logs</h3>
        <p className="text-white/60 text-lg mt-2">Automated entries for subscriptions and rent.</p>
      </div>
      <div className="relative">
        <div className="absolute w-4 h-4 bg-white/20 rounded-full -left-[41px] top-2"></div>
        <h3 className="text-3xl font-bold">Biometric Lock</h3>
        <p className="text-white/60 text-lg mt-2">FaceID / Fingerprint layer for local security.</p>
      </div>
    </div>
  </div>
);
...
const Slide20 = () => (
  <div className="w-full h-full flex flex-col justify-center items-center text-center max-w-6xl mx-auto">
    <h2 className="text-6xl md:text-[5rem] font-black uppercase tracking-tighter leading-none mb-8 font-['Horizon','Outfit',sans-serif]">
      FAST.<br/>SECURE.<br/>PRIVATE.
    </h2>
    <p className="text-2xl text-white/60 font-medium">Ready to scale locally.</p>
  </div>
);
...
const Slide21 = () => (
  <div className="w-full h-full flex flex-col justify-center items-center text-center max-w-5xl mx-auto">
    <h2 className="text-7xl font-black uppercase tracking-tight mb-4 font-['Horizon','Outfit',sans-serif]">THANK YOU</h2>
...
for (const [num, content] of Object.entries(templates)) {
  const fileName = \`Slide\${num.padStart(2, '0')}.jsx\`;
...
// Generate index.js
const indexContent = Object.keys(templates).map(num => \`export { default as Slide\${num.padStart(2, '0')} } from './Slide\${num.padStart(2, '0')}';\`).join('\\n');
fs.writeFileSync(path.join(slidesDir, 'index.js'), indexContent);
