    ...
    <div className="bg-[#0A0E14] text-white h-screen overflow-y-scroll snap-y snap-mandatory scroll-smooth no-scrollbar font-sans">
      ...
      <section className="h-screen w-full snap-start flex flex-col justify-center px-6 md:px-24">
        <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-16 items-center">
          <div className="hidden md:block"><div className="w-full h-[600px] bg-[#151B23] border border-white/5 rounded-[4rem] flex items-center justify-center shadow-[0_0_100px_rgba(34,197,94,0.1)] overflow-hidden"><img src="/logo.png" alt="Ledger Logo" className="w-[80%] h-[80%] object-contain animate-pulse rounded-[2rem]" /></div></div>
          <div>
