...
export default function Slide15() {
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="w-full flex flex-col items-center">
      ...
      <motion.h2 variants={anim} className="text-[32px] md:text-[36px] font-[700] text-[#ff3333] mb-[30px] text-center">Spending Insights</motion.h2>
      <div className="w-full max-w-[1200px] flex justify-between items-center text-left">
        <motion.div variants={anim} className="w-[50%] flex justify-center bg-transparent">
          <div className="rounded-[32px] overflow-hidden border-[6px] border-[#222222] shadow-[0_30px_80px_rgba(0,0,0,0.6)] w-full max-h-[75vh] flex items-center justify-center bg-[#000000]">
             <img src="/image_4.webp" alt="Screenshot" className="w-full h-full object-contain" loading="lazy" decoding="async" />
          </div>
        </motion.div>
        <motion.div variants={anim} className="w-[45%] bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.08)] p-[32px] rounded-[16px]">
          <h3 className="text-[28px] md:text-[32px] font-[700] text-[#ffffff] mb-[20px]">Visualizing Data</h3>
          <p className="text-[18px] md:text-[22px] text-[#b0b0b0] font-[400] leading-[1.6] whitespace-pre-line">Looking at long lists of numbers can be boring and confusing.\n\nThe insights tab takes all your expenses and turns them into beautiful visual charts. You can instantly see exactly which categories are eating up most of your budget, helping you make better financial decisions.</p>
        </motion.div>
      </div>
    </motion.div>
  );
