  ...
  return (
    <div className="w-full flex flex-col items-center text-center">
      <motion.h1 
        ...
        className="text-[72px] text-[#ffffff] font-[700] leading-[1.2] mb-[20px]"
      >
        Introduction
      </motion.h1>
      <motion.h2 
        initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.15 }}
        className="text-[32px] text-[#ff3333] font-bold font-[500] leading-[1.2] mb-[20px]"
      >
        The Need for Financial Privacy
      </motion.h2>
      
      <motion.div variants={container} initial="hidden" animate="show" className="text-[22px] text-[#b0b0b0] leading-[1.7] max-w-[1200px] mb-[15px]">
