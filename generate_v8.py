...
# Update CSS
css_content = """@import url('https://fonts.googleapis.com/css2?family=Syne:wght@400;500;600;700;800&display=swap');
@import "tailwindcss";
...
# Reusable templates
heading_anim = """
      <motion.h1 variants={anim} className="text-[84px] md:text-[96px] font-[800] text-[#ffffff] mb-[30px] leading-tight text-center">{title}</motion.h1>
      <motion.h2 variants={anim} className="text-[32px] md:text-[36px] font-[700] text-[#ff3333] mb-[50px] text-center">{subtitle}</motion.h2>
"""
...
export default function Slide{idx}() {{
  return (
    <motion.div variants={{container}} initial="hidden" animate="show" className="w-full flex flex-col items-center">
      <motion.h1 variants={{anim}} className="text-[84px] md:text-[96px] font-[800] text-[#ffffff] mb-[30px] text-center">{title}</motion.h1>
      <motion.h2 variants={{anim}} className="text-[32px] md:text-[36px] font-[700] text-[#ff3333] mb-[50px] text-center">{subtitle}</motion.h2>
      <div className="w-full max-w-[1200px] flex justify-between items-center text-left">
        <motion.div variants={{anim}} className="w-[45%] flex justify-center bg-transparent">
          <img src="{image_src}" alt="Screenshot" className="w-full max-h-[65vh] object-contain mix-blend-lighten" />
        </motion.div>
        <motion.div variants={{anim}} className="w-[50%] bg-[rgba(255,255,255,0.03)] backdrop-blur-[12px] border border-[rgba(255,255,255,0.06)] p-[32px] rounded-[16px]">
          <h3 className="text-[28px] font-[700] text-[#ffffff] mb-[24px]">{desc_head}</h3>
          <p className="text-[20px] md:text-[22px] text-[#b0b0b0] font-[400] leading-[1.6] whitespace-pre-line">{desc_body}</p>
        </motion.div>
      </div>
    </motion.div>
  );
